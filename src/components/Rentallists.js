...
<div className=' border-r-2 border-l-2 border-b-2 border-gray-200 mt-24 inline-flex px-12 w-5/5 mx-24 h-16  mb-8 rounded-lg '>
        ...
        <div className=' px-2 mt-2'><span className='text-black font-bold'>Location</span><select className='outline-none bg-transparent text-black'><option >select the area</option></select></div>
        <div className='px-2 mt-2'><span className='text-black font-bold'>Type of property</span><select className='outline-none bg-transparent text-black'><option >All type</option></select></div>
        <div className='px-2 mt-2'><span className='text-black font-bold'>Bedrooms</span><select className='outline-none bg-transparent text-black'><option>number of Bedrooms</option></select></div>
        <div className='px-2 mt-1'><span className='text-black font-bold'>Bathrooms</span><select className='outline-none bg-transparent text-black'><option>number of Bathrooms</option></select></div>
        <div className='px-2 mt-2'><span className='text-black font-bold'>Pricerange</span><select className='outline-none bg-transparent text-black'><option>min and max</option></select></div>
        <div className='mt-1'><label class=" relative inline-flex">
  
  <input class=" bg-blue-700 w-28 rounded-md py-2 placeholder:text-white shadow-sm outline-none placeholder:px-2 h-10" placeholder="Search" type="text" name="search"/>
